...
import { MdFlight, MdHolidayVillage, MdOutlineLocalHotel } from "react-icons/md";
                ...
                <div data-aos="zoom-in" className="grid grid-cols-2 gap-6">
                  <div className="space-y-6">
                    {/* <div className="flex items-center gap-4">
                      <Mdship className="text-4xl h-12 w-12 shadow-sm p-4 rounded-full bg-violet-100 dark:bg-violet-400" />
                      <p>Flight</p>
                    </div> */}
                    <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-4">
                      <MdHolidayVillage className="text-4xl h-12 w-12 shadow-sm p-4 rounded-full bg-orange-100 dark:bg-orange-400" />
                      <p>Hicking of the hills </p>
                    </div>
                  </div>
                  <div className="space-y-6">
                    <div className="flex items-center gap-4">
